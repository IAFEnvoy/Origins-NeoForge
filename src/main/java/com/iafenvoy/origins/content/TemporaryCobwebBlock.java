...
public class TemporaryCobwebBlock extends WebBlock {
    ...
    public TemporaryCobwebBlock(BlockBehaviour.Properties properties) {
        super(properties.mapColor(MapColor.WOOL).strength(4.0F).requiresCorrectToolForDrops().noCollision());
    }
