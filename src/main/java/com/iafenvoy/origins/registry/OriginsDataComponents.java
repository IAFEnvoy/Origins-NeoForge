...
public final class OriginsDataComponents {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<ItemPowersComponent>> ITEM_POWERS = REGISTRY.register("item_powers", () -> DataComponentType.<ItemPowersComponent>builder().persistent(ItemPowersComponent.CODEC).build());
}
