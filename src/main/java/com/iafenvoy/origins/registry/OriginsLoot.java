...
public final class OriginsLoot {
    ...
    private static final ResourceKey<Enchantment> WATER_PROTECTION = ResourceKey.create(Registries.ENCHANTMENT, Identifier.fromNamespaceAndPath(Origins.MOD_ID, "water_protection"));
