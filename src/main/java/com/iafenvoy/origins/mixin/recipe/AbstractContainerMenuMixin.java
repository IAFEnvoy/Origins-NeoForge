...
public class AbstractContainerMenuMixin {
    ...
    private Optional<ItemStack> performAfterCraftingActions(Optional<ItemStack> original, int slotIndex, int button, ContainerInput actionType, Player player, @Local Slot slot) {
