...
public final class WaterBreathingHelper {
    private static final ResourceKey<DamageType> NO_WATER_FOR_GILLS = ResourceKey.create(Registries.DAMAGE_TYPE, Identifier.fromNamespaceAndPath(Origins.MOD_ID, "no_water_for_gills"));
