...
public record Modifier(double value, ModifierOperation operation, Optional<Identifier> resource,
    ...
    public static final Codec<Modifier> CODEC = Codec.recursive(Modifier.class.getSimpleName(), codec -> RecordCodecBuilder.create(i -> i.group(
            ...
            Identifier.CODEC.optionalFieldOf("resource").forGetter(Modifier::resource),
    ...
    //仅在通过 ModifierPowerHelper 调用时触发事件
