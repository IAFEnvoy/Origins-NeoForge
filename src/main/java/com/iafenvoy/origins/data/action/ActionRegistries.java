...
public final class ActionRegistries {
    public static final ResourceKey<Registry<MapCodec<? extends BiEntityAction>>> BI_ENTITY_ACTION_KEY = ResourceKey.createRegistryKey(Identifier.fromNamespaceAndPath(Origins.MOD_ID, "bi_entity_action"));
    public static final ResourceKey<Registry<MapCodec<? extends BlockAction>>> BLOCK_ACTION_KEY = ResourceKey.createRegistryKey(Identifier.fromNamespaceAndPath(Origins.MOD_ID, "block_action"));
    public static final ResourceKey<Registry<MapCodec<? extends EntityAction>>> ENTITY_ACTION_KEY = ResourceKey.createRegistryKey(Identifier.fromNamespaceAndPath(Origins.MOD_ID, "entity_action"));
    public static final ResourceKey<Registry<MapCodec<? extends ItemAction>>> ITEM_ACTION_KEY = ResourceKey.createRegistryKey(Identifier.fromNamespaceAndPath(Origins.MOD_ID, "item_action"));
