...
public enum Impact {
    NONE(0, "none", ChatFormatting.GRAY, Identifier.fromNamespaceAndPath(Origins.MOD_ID, "choose_origin/impact/none")),
    LOW(1, "low", ChatFormatting.GREEN, Identifier.fromNamespaceAndPath(Origins.MOD_ID, "choose_origin/impact/low")),
    MEDIUM(2, "medium", ChatFormatting.YELLOW, Identifier.fromNamespaceAndPath(Origins.MOD_ID, "choose_origin/impact/medium")),
    HIGH(3, "high", ChatFormatting.RED, Identifier.fromNamespaceAndPath(Origins.MOD_ID, "choose_origin/impact/high"));
    ...
    Impact(int impactValue, String translationKey, ChatFormatting textStyle, Identifier spriteId) {
