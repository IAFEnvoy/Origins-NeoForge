...
public class ActionWhenHitPower extends HasCooldownPower {
    ...
    public static void onDamage(LivingDamageEvent.Post event) {
        ...
        holder.getHelper().execute(ActionWhenHitPower.class,
                p -> p.biEntityCondition.test(source, target) && p.damageCondition.test(event.getSource(), event.getInflictedDamage()),
