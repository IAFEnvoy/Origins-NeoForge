...
public class EntitySetComponent extends PowerComponent implements ComponentHolderProvider<EntitySetComponent.SetHolder> {
    ...
    public record SetHolder(OriginDataHolder holder, EntitySetComponent component) {
        public void addEntity(Identifier id, Entity target) {
            this.addEntity(id, target, -1);
        }

        //-1 表示无限
        public void addEntity(Identifier id, Entity target, int timeLimit) {
        ...
        public void removeEntity(Identifier id, Entity target) {
            if (this.component.set.containsKey(target.getUUID())) {
        ...
        public void postAdd(Identifier id, Entity target) {
        ...
        public void postRemove(Identifier id, Entity target) {
            if (target != null)
