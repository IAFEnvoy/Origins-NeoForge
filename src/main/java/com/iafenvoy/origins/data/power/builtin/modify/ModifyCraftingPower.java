...
public class ModifyCraftingPower extends Power {
    public static final MapCodec<ModifyCraftingPower> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(
            ...
            Identifier.CODEC.optionalFieldOf("recipe").forGetter(ModifyCraftingPower::getRecipe),
    ...
    private final Optional<Identifier> recipe;
    ...
    public ModifyCraftingPower(BaseSettings settings, Optional<Identifier> recipe, ItemCondition itemCondition, Optional<ItemStack> result, ItemAction itemAction, EntityAction entityAction, BlockAction blockAction, ItemAction itemActionAfterCrafting) {
        super(settings);
        this.recipe = recipe;
    ...
    public Optional<Identifier> getRecipe() {
        return this.recipe;
    }
    ...
    public boolean doesApply(Entity entity, Identifier targetRecipeId, ItemStack originalResultStack) {
