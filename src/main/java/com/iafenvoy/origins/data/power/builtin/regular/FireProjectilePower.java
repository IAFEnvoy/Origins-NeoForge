...
@NotImplementedYet
public class FireProjectilePower extends Power implements Toggleable {
    ...
    public FireProjectilePower(BaseSettings settings, EntityType<?> entityType, CooldownSettings cooldown, int count, int interval, int startDelay, float speed, float divergence, Optional<ResourceLocation> sound, Optional<CompoundTag> tag, KeySettings key, EntityAction projectileAction, EntityAction shooterAction) {
        super(settings);
