...
public class OverlayPower extends Power {
    public static final MapCodec<OverlayPower> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(
            ...
            Identifier.CODEC.fieldOf("texture").forGetter(OverlayPower::getTexture),
    ...
    public OverlayPower(BaseSettings settings, Identifier texture, float strength, ColorSettings color, DrawMode drawMode, DrawPhase drawPhase, boolean hideWithHud, boolean visibleInThirdPerson) {
        super(settings);
