...
public class ModifyFluidRenderPower extends Power {
    ...
    public BlockCondition getBlockCondition() { return this.blockCondition; }
    public FluidCondition getFluidCondition() { return this.fluidCondition; }
    public FluidState getFluid() { return this.fluid; }

    @Override public @NotNull MapCodec<? extends Power> codec() { return CODEC; }
    @Override public void active(@NotNull OriginDataHolder holder) { LevelRenderHelper.sendReloadPayload(holder.getEntity()); }
    @Override public void inactive(@NotNull OriginDataHolder holder) { LevelRenderHelper.sendReloadPayload(holder.getEntity()); }
}
