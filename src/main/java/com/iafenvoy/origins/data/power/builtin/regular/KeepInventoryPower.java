...
public class KeepInventoryPower extends Power {
    ...
    public static void playerClone(PlayerEvent.Clone event) {
        ...
        if (!((net.minecraft.server.level.ServerLevel) event.getEntity().level()).getGameRules().get(GameRules.KEEP_INVENTORY))
    ...
    public static void onPlayerDeath(LivingDeathEvent event) {
        if (event.getEntity() instanceof Player player) {
            ...
            if (!((net.minecraft.server.level.ServerLevel) player.level()).getGameRules().get(GameRules.KEEP_INVENTORY))
