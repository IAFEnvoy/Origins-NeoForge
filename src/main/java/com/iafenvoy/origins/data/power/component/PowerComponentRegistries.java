...
public final class PowerComponentRegistries {
    public static final ResourceKey<Registry<MapCodec<? extends PowerComponent>>> POWER_COMPONENT_TYPE_KEY = ResourceKey.createRegistryKey(Identifier.fromNamespaceAndPath(Origins.MOD_ID, "power_component_type"));
