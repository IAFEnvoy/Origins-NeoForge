...
public final class ActionPowers {
    ...
    public static final DeferredHolder<MapCodec<? extends Power>, MapCodec<ActionOnAttackerHurtPower>> ACTION_ON_ATTACKER_HURT = REGISTRY.register("action_on_attacker_hurt", () -> ActionOnAttackerHurtPower.CODEC);
    public static final DeferredHolder<MapCodec<? extends Power>, MapCodec<ActionOnBonemealPower>> ACTION_ON_BONEMEAL = REGISTRY.register("action_on_bonemeal", () -> ActionOnBonemealPower.CODEC);
    ...
    public static final DeferredHolder<MapCodec<? extends Power>, MapCodec<ActionOnEquipPower>> ACTION_ON_EQUIP = REGISTRY.register("action_on_equip", () -> ActionOnEquipPower.CODEC);
    ...
    public static final DeferredHolder<MapCodec<? extends Power>, MapCodec<ActionOnJumpPower>> ACTION_ON_JUMP = REGISTRY.register("action_on_jump", () -> ActionOnJumpPower.CODEC);
    public static final DeferredHolder<MapCodec<? extends Power>, MapCodec<ActionOnProjectileHitPower>> ACTION_ON_PROJECTILE_HIT = REGISTRY.register("action_on_projectile_hit", () -> ActionOnProjectileHitPower.CODEC);
    ...
    public static final DeferredHolder<MapCodec<? extends Power>, MapCodec<ActionOnTargetDeathPower>> ACTION_ON_TARGET_DEATH = REGISTRY.register("action_on_target_death", () -> ActionOnTargetDeathPower.CODEC);
    ...
    public static final DeferredHolder<MapCodec<? extends Power>, MapCodec<ActionWhenTameHitPower>> ACTION_WHEN_TAME_HIT = REGISTRY.register("action_when_tame_hit", () -> ActionWhenTameHitPower.CODEC);
