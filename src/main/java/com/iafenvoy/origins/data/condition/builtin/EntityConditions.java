...
public final class EntityConditions {
    ...
    public static final DeferredHolder<MapCodec<? extends EntityCondition>, MapCodec<? extends EntityCondition>> DAYTIME = REGISTRY.register("daytime", () -> createEntity(entity -> entity.level().getOverworldClockTime() % 24000L < 13000L));
    ...
    public static final DeferredHolder<MapCodec<? extends EntityCondition>, MapCodec<? extends EntityCondition>> TAMED = REGISTRY.register("tamed", () -> createEntity(entity -> entity instanceof OwnableEntity ownable && ownable.getOwnerReference() != null));
