...
public final class BlockConditions {
    ...
    public static final DeferredHolder<MapCodec<? extends BlockCondition>, MapCodec<? extends BlockCondition>> EXPOSED_TO_SKY = REGISTRY.register("exposed_to_sky", () -> createBlock((level, pos) -> level.canSeeSky(pos)));
