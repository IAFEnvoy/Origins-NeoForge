...
public final class BiEntityConditions {
    ...
    public static final DeferredHolder<MapCodec<? extends BiEntityCondition>, MapCodec<? extends BiEntityCondition>> OWNER = REGISTRY.register("owner", () -> createBiEntity((source, target) -> target instanceof OwnableEntity ownable && ownable.getOwnerReference() != null && Objects.equals(ownable.getOwnerReference().getUUID(), source.getUUID())));
