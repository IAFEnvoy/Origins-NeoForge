...
public final class NetworkManager {
    ...
    public static void registerPayloads(RegisterPayloadHandlersEvent event) {
        event.registrar("1")
                ...
                .playToServer(RequestRecipeBadgeC2SPayload.TYPE, RequestRecipeBadgeC2SPayload.STREAM_CODEC, new MainThreadPayloadHandler<>(ServerNetworkHandler::onRequestRecipeBadge))
                .playToClient(RecipeBadgeS2CPayload.TYPE, RecipeBadgeS2CPayload.STREAM_CODEC, new MainThreadPayloadHandler<>(ClientNetworkHandler::onRecipeBadge))
